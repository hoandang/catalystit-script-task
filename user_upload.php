...
$cli = new Cli;
$cli
  ->opt('file', '[csv file name] – this is the name of the CSV to be parsed (required)', true)
  ...
  ->opt('db_host:h', 'MySQL host (required)', true) 
  ->opt('db_username:u', 'MySQL username (required)', true) 
  ->opt('db_password:p', 'MySQL password (required)', true);
